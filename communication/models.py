...
class Messages(models.Model):
    ...
    def get_items_as_dict(self):
        ...
        return dict({"id": self.id, "owner": self.owner, "text": self.text, "timestamp": self.get_time_humanised(), "recipient": self.recipient, "isgroup": self.isGroup, "groupID": self.groupId})
